...
public class openCmd implements EventModeAdminInterface {
    @Override
    public boolean onCommand(CommandSender sender, Command cmd, String commandLabel, String[] args) {
        ...
        if (eventMode.isOpenMsg(p)) return false;
        if (eventMode.isLobbyNullMsg(p)) return false;
        eventMode.openEvent(p);
        return false;
    }
}
